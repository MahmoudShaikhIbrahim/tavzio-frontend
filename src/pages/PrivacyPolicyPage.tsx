            ...
            <nav className="mt-4 space-y-1">
              {SECTIONS.map((s) => (
                <button
                  ...
                  type="button"
                  onClick={() => jumpTo(s.id)}
                  className={`block w-full rounded-full px-3 py-2 text-left text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass ${
            ...
            <nav className="mt-4 space-y-1">
              {SECTIONS.map((s) => (
                <button
                  ...
                  type="button"
                  onClick={() => jumpTo(s.id)}
                  className={`block w-full rounded-full px-3 py-2.5 text-left text-base transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass ${
