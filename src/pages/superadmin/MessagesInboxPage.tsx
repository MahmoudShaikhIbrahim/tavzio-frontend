  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <form onSubmit={handleSend} className="flex gap-2 border-t border-ink-line p-3">
        ...
        />
        <button disabled={sending} className="shrink-0 rounded-full bg-brass px-4 py-2 text-base font-medium text-ink disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass">
          Send
        </button>
      </form>
    </div>
