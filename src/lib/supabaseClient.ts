...
export function subscribeToBusinessTable(
  businessId: string,
  table: 'events' | 'loyalty_memberships' | 'loyalty_transactions' | 'cards' | 'orders' | 'order_items' | 'bookings' | 'payments' | 'custom_buttons' | 'support_messages' | 'loyalty_reward_claims' | 'housekeeping_tasks' | 'maintenance_tickets' | 'guest_service_requests' | 'profiles' | 'tables' | 'floor_plan_cells',
